  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="grid grid-cols-1 gap-5 px-5 sm:gap-6 md:grid-cols-2 lg:gap-7 sm:px-8 lg:px-12">
          <article>
            <div className="group relative aspect-[329/246] cursor-pointer overflow-hidden rounded-2xl bg-[#1a1d2e]">
              ...
              />
              <div className="absolute bottom-4 left-4 flex h-9 w-9 flex-row-reverse items-center overflow-hidden rounded-full bg-white transition-all duration-300 ease-in-out group-hover:w-[148px]">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center text-gray-900">
                  <LinkIcon />
                </span>
                <span className="whitespace-nowrap pl-4 text-[13px] font-medium text-gray-900 opacity-0 transition-opacity duration-300 delay-100 group-hover:opacity-100">
                  Learn more
                </span>
              </div>
            </div>
          ...
          <article>
            <div className="group relative aspect-square cursor-pointer overflow-hidden rounded-2xl bg-[#6b6b6b]">
              <video
                ...
                className="h-full w-full object-cover"
              />
              <div className="absolute bottom-4 left-4 flex h-9 w-9 flex-row-reverse items-center overflow-hidden rounded-full bg-gray-900 transition-all duration-300 ease-in-out group-hover:w-[168px]">
                ...
                <span className="whitespace-nowrap pl-4 text-[13px] font-medium text-white opacity-0 transition-opacity duration-300 delay-100 group-hover:opacity-100">
                  View case study
                </span>
              </div>
            </div>
